...
const Carousel = () => {
  ...
  const slides = [
    { src: Image1, name: "Blower Motor", key:"Efficient Climate Control for a Comfortable Ride"},
    ...
    { src: Image7, name: "Wiper Motor", key:"Clear Visibility, No Matter the Weather" },
