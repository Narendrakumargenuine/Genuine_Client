            ...
            <div className="aboutus-border"></div>
              ...
              <div>
               ...
               <div>
                ...
                <p className="p-span">We use your information to:</p>
                ...
                <div>
                  ...
                  <p className="p-span">Your information will only be shared:</p>
              ...
              <ul style={{marginLeft:"25px"}}>
               ...
               <ul style={{marginLeft:"25px"}}>
                ...
                <div>
                  ...
                  <p className="p-span">You have the right to:</p>
             <ul style={{marginLeft:"25px"}}>
